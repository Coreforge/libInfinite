...
#define FLAGS_2_IS_SEAM (1<<0)


// Field flags_3

#define FLAGS_3_ABOVE (1<<0)


// Field flags_4

#define FLAGS_4_AI_CANT_HEAR_THROUGH_THIS_SHIT (1<<0)
#define FLAGS_4_ONE_WAY (1<<1)
#define FLAGS_4_NO_WAY (1<<2)
#define FLAGS_4_ONE_WAY_REVERSED (1<<3)
#define FLAGS_4_NO_ONE_CAN_HEAR_THROUGH_THIS (1<<4)


// Field flags_5

#define FLAGS_5_CONTAINS_DOUBLE_SIDED_SURFACES (1<<0)


// Field flags_6

#define FLAGS_6_TWO_SIDED (1<<0)
#define FLAGS_6_INVISIBLE (1<<1)
#define FLAGS_6_CLIMBABLE (1<<2)
#define FLAGS_6_INVALID (1<<3)
#define FLAGS_6_CONVEYOR (1<<4)
#define FLAGS_6_SLIP (1<<5)
#define FLAGS_6_PLANE_NEGATED (1<<6)


// Field flags_7

#define FLAGS_7_RENDERED (1<<0)
#define FLAGS_7_TANGENT_SPACE (1<<1)
#define FLAGS_7_NON_CRITICAL (1<<2)
#define FLAGS_7_LIGHTMAP_LIGHT (1<<3)
#define FLAGS_7_REPORT_KEY_IS_VALID (1<<4)


// Field flags_8

#define FLAGS_8_RENDERED (1<<0)
#define FLAGS_8_TANGENT_SPACE (1<<1)
#define FLAGS_8_NON_CRITICAL (1<<2)
#define FLAGS_8_LIGHTMAP_LIGHT (1<<3)
#define FLAGS_8_REPORT_KEY_IS_VALID (1<<4)


// Field flags_9

#define FLAGS_9_RENDER_ONLY (1<<0)
#define FLAGS_9_DOES_NOT_BLOCK_AOE_DAMAGE (1<<1)
#define FLAGS_9_REMOVE_FROM_DYNAMIC_SHADOW_GEOMETRY (1<<2)
#define FLAGS_9_CINEMA_ONLY (1<<3)
#define FLAGS_9_EXCLUDE_FROM_CINEMA (1<<4)
#define FLAGS_9_DISABLE_PLAY_COLLISION (1<<5)
#define FLAGS_9_DISABLE_BULLET_COLLISION (1<<6)
#define FLAGS_9_IGNORE_CUBEMAP_VOLUME (1<<7)
#define FLAGS_9_ALWAYS_GENERATE_FLOATING_SHADOW (1<<8)
#define FLAGS_9_PVS_ALWAYS_VISIBLE (1<<9)
#define FLAGS_9_PVS_ALWAYS_USE_LOD_0 (1<<10)
#define FLAGS_9_PVS_DONT_USE_AS_AN_OCCLUDER (1<<11)
#define FLAGS_9_EXCLUDE_FROM_INTEL_MAP (1<<12)
#define FLAGS_9_EXCLUDE_FROM_BROADPHASE_CALCULATION (1<<13)
#define FLAGS_9_CAN_GENERATE_DECORATORS (1<<14)
#define FLAGS_9_ISHLOD (1<<15)
...
#define FLAGS_10_RENDER_ONLY (1<<0)
#define FLAGS_10_DOES_NOT_BLOCK_AOE_DAMAGE (1<<1)
#define FLAGS_10_REMOVE_FROM_DYNAMIC_SHADOW_GEOMETRY (1<<2)
#define FLAGS_10_CINEMA_ONLY (1<<3)
#define FLAGS_10_EXCLUDE_FROM_CINEMA (1<<4)
#define FLAGS_10_DISABLE_PLAY_COLLISION (1<<5)
#define FLAGS_10_DISABLE_BULLET_COLLISION (1<<6)
#define FLAGS_10_IGNORE_CUBEMAP_VOLUME (1<<7)
#define FLAGS_10_ALWAYS_GENERATE_FLOATING_SHADOW (1<<8)
#define FLAGS_10_PVS_ALWAYS_VISIBLE (1<<9)
#define FLAGS_10_PVS_ALWAYS_USE_LOD_0 (1<<10)
#define FLAGS_10_PVS_DONT_USE_AS_AN_OCCLUDER (1<<11)
#define FLAGS_10_EXCLUDE_FROM_INTEL_MAP (1<<12)
#define FLAGS_10_EXCLUDE_FROM_BROADPHASE_CALCULATION (1<<13)
#define FLAGS_10_CAN_GENERATE_DECORATORS (1<<14)
#define FLAGS_10_ISHLOD (1<<15)


// Field flags2_2

#define FLAGS2_2_CONTAINS_DECAL_PARTS (1<<0)
#define FLAGS2_2_NEGATIVE_SCALE (1<<1)
#define FLAGS2_2_IS_QUICK_DELETED (1<<2)
#define FLAGS2_2_SUPPORTS_COATINGS (1<<3)
#define FLAGS2_2_WANTS_HOLOGRAM_OVERRIDE (1<<4)
#define FLAGS2_2_COATINGS_SETUP_ON_INITIAL_FRAME (1<<5)


// Field mesh_flags_override_2

#define MESH_FLAGS_OVERRIDE_2_MESH_HAS_VERTEX_COLOR (1<<0)
#define MESH_FLAGS_OVERRIDE_2_USE_REGION_INDEX_FOR_SORTING (1<<1)
#define MESH_FLAGS_OVERRIDE_2_CAN_BE_RENDERED_IN_DRAW_BUNDLES (1<<2)
#define MESH_FLAGS_OVERRIDE_2_MESH_IS_CUSTOM_SHADOW_CASTER (1<<3)
#define MESH_FLAGS_OVERRIDE_2_MESH_IS_UNINDEXED_DO_NOT_MODIFY (1<<4)
#define MESH_FLAGS_OVERRIDE_2_MASH_SHOULD_RENDER_IN_Z_PREPASS (1<<5)
#define MESH_FLAGS_OVERRIDE_2_USE_UNCOMPRESSED_VERTEX_FORMAT (1<<6)
#define MESH_FLAGS_OVERRIDE_2_MESH_IS_PCA (1<<7)
#define MESH_FLAGS_OVERRIDE_2_MESH_HAS_A_USEFUL_SET_OF_SECOND_TEXTURE_COORDS (1<<8)
#define MESH_FLAGS_OVERRIDE_2_MESH_HAS_A_USEFUL_SET_OF_THIRD_TEXTURE_COORDS (1<<9)
#define MESH_FLAGS_OVERRIDE_2_USE_UV3_TANGENT_ROTATION (1<<10)
...
#define FLAGS_11_ALLOW_DECALS (1<<0)
#define FLAGS_11_IS_TRIGGER_VOLUME (1<<1)
...
#define FLAGS_12_INDICES_ARE_TRIANGLE_STRIPS (1<<0)
#define FLAGS_12_INDICES_ARE_TRIANGLE_LISTS (1<<1)
#define FLAGS_12_INDICES_ARE_QUAD_LISTS (1<<2)
...
#define FLAGS_13_CONTAINS_DOUBLE_SIDED_SURFACES (1<<0)


// Field flags_14

#define FLAGS_14_TWO_SIDED (1<<0)
#define FLAGS_14_INVISIBLE (1<<1)
#define FLAGS_14_CLIMBABLE (1<<2)
#define FLAGS_14_INVALID (1<<3)
#define FLAGS_14_CONVEYOR (1<<4)
#define FLAGS_14_SLIP (1<<5)
#define FLAGS_14_PLANE_NEGATED (1<<6)


// Field flags_15

#define FLAGS_15_CONTAINS_DOUBLE_SIDED_SURFACES (1<<0)


// Field flags_16

#define FLAGS_16_TWO_SIDED (1<<0)
#define FLAGS_16_INVISIBLE (1<<1)
#define FLAGS_16_CLIMBABLE (1<<2)
#define FLAGS_16_INVALID (1<<3)
#define FLAGS_16_CONVEYOR (1<<4)
#define FLAGS_16_SLIP (1<<5)
#define FLAGS_16_PLANE_NEGATED (1<<6)


// Field flags_17

#define FLAGS_17_CONTAINS_DOUBLE_SIDED_SURFACES (1<<0)


// Field flags_18

#define FLAGS_18_TWO_SIDED (1<<0)
#define FLAGS_18_INVISIBLE (1<<1)
#define FLAGS_18_CLIMBABLE (1<<2)
#define FLAGS_18_INVALID (1<<3)
#define FLAGS_18_CONVEYOR (1<<4)
#define FLAGS_18_SLIP (1<<5)
#define FLAGS_18_PLANE_NEGATED (1<<6)


// Field flags_19

#define FLAGS_19_CONTAINS_DOUBLE_SIDED_SURFACES (1<<0)


// Field flags_20

#define FLAGS_20_TWO_SIDED (1<<0)
#define FLAGS_20_INVISIBLE (1<<1)
#define FLAGS_20_CLIMBABLE (1<<2)
#define FLAGS_20_INVALID (1<<3)
#define FLAGS_20_CONVEYOR (1<<4)
#define FLAGS_20_SLIP (1<<5)
#define FLAGS_20_PLANE_NEGATED (1<<6)
...
#define PHYSICS_OVERRIDE_FLAGS_IS_TRIGGER_VOLUME (1<<1)


// Field physics_instance_flags_Mask

#define PHYSICS_INSTANCE_FLAGS_MASK_ALLOW_DECALS (1<<0)
#define PHYSICS_INSTANCE_FLAGS_MASK_IS_TRIGGER_VOLUME (1<<1)
...
#define FLAGS_21_DELETE_BIT (1<<0)
#define FLAGS_21_ADJUSTED_BIT (1<<1)
#define FLAGS_21_APPROXIMATED_POSITION_BIT (1<<2)
...
// Enum Trigger_Volume_Callback_Type

enum Trigger_Volume_Callback_Type_enum {
    TRIGGER_VOLUME_CALLBACK_TYPE_NONE,
    TRIGGER_VOLUME_CALLBACK_TYPE_WATER
};
...
struct instanced_foliage_instances{
    ...
    struct material_override_data{
        ...
        uint32_t per_Instance_Material_Vector1;
        uint32_t per_Instance_Material_Vector2;
        uint16_t flags_mesh_flags_override_2;
        uint16_t generated_pad58dd;
    };
    struct material_override_data material_override_data_ent;
    struct point3D rectMin;
...
struct instanced_physics_instances{
    ...
    uint32_t m_guid;
// Array with 4 elements
    uint64_t havok_body_ID[4];
    uint8_t flags_flags_11;
    uint32_t generated_pad119d;
    uint16_t generated_pad119d_2;
    uint8_t generated_pad119d_3;
    uint64_t m_scene;
    uint8_t enum_Trigger_Volume_Callback_Type;
    uint32_t generated_padf7bc;
    uint16_t generated_padf7bc_2;
    uint8_t generated_padf7bc_3;
};
...
// Array with 16 elements
    ...
    uint32_t generated_pad0245;
    uint16_t generated_pad0245_2;
    uint8_t generated_pad0245_3;
...
// Array with 1024 elements
    ...
    uint16_t generated_pad0ad3_2;
    uint8_t generated_pad0ad3_3;
};
