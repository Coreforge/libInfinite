...
#define FLAGS_IS_HOLOGRAM (1<<0)
#define FLAGS_HAS_NODE_MAPS (1<<1)
#define FLAGS_LOD_REGIONS_ENABLED (1<<2)
#define FLAGS_HAS_CUSTOM_SHADOW_MESHES (1<<3)
#define FLAGS_IS_HOLOGRAM_LOFI (1<<4)
#define FLAGS_HAS_SKINNED_TREE_PARTS (1<<5)
#define FLAGS_SUPPORTS_MATERIAL_COATINGS (1<<6)
...
enum mesh_resource_packing_policy_enum {
    ...
    MESH_RESOURCE_PACKING_POLICY_RESOURCE_PER_MESH_PERMUTATION
};

// Enum Default_Load_Variant_Policy

enum Default_Load_Variant_Policy_enum {
    DEFAULT_LOAD_VARIANT_POLICY_ALL_VARIANTS,
    DEFAULT_LOAD_VARIANT_POLICY_FIRST_VARIANT,
    DEFAULT_LOAD_VARIANT_POLICY_NO_VARIANT
};
...
enum procedure_enum {
    PROCEDURE_NONE,
    PROCEDURE_MULTIPLY_ROTATION,
    PROCEDURE_COPY_SCALED_TWIST,
    PROCEDURE_LOOK_AT,
    PROCEDURE_COPY_LOCAL_ORIENTATION,
    PROCEDURE_COPY_SCALED_TWIST_LEGACY
};

// Enum procedure_axis

enum procedure_axis_enum {
    PROCEDURE_AXIS_ALL,
    PROCEDURE_AXIS_YAW_MAYA_Y,
    PROCEDURE_AXIS_PITCH_MAYA_X,
    PROCEDURE_AXIS_ROLL_MAYA_Z
};
...
struct regions{
    string_id name;
    struct tagBlock<permutations> permutations_ent;
};
...
struct nodes{
    ...
    struct vector3D inverse_left;
    struct vector3D inverse_up;
    struct point3D inverse_position;
    float inverse_scale;
    float distance_from_parent;
    // CUSTOM: Procedural_Joint
    uint8_t enum_procedure;
    uint8_t enum_procedure_axis;
    uint8_t procedure_index;
    uint8_t generated_pad3a2d;
    shortBlockIndex procedure_node_A;
    shortBlockIndex procedure_node_B;
    float procedure_var_1;
    float procedure_var_2;
    realEulerAngle3D procedure_neutral_offset;
    // CUSTOM: 
};


struct Bone_Settings{
    shortBlockIndex Node;
    uint16_t generated_pad07da;
    float Spring_Coefficient;
    float Dampening_Fraction0_1;
    angle Max_Angle;
};
...
struct node_map_mapping{
    uint16_t instance_node_map_region_node_index;
};


struct runtime_node_orientations{
    realQuaternion rotation;
    struct point3D translation;
    float scale;
};
...
struct bones{
    shortBlockIndex node_index;
};


struct bone_groups{
    string_id name;
    struct tagBlock<bones> bones_ent;
};
...
struct cloth_datas{
    ...
    struct tagBlock<meshIndex> meshIndex_ent;
    struct dataReference havokData;
};
...
struct mode{
    ...
    uint16_t flags_flags;
    uint16_t version;
    uint32_t enum_mesh_resource_packing_policy;
    uint8_t enum_Default_Load_Variant_Policy;
    uint8_t generated_padd53e;
    uint16_t generated_padd53e_2;
    uint32_t Number_of_LODS_to_make_required_memory;
    // CUSTOM: 
    uint32_t runtime_import_info_checksum;
    // CUSTOM: 
    struct tagBlock<regions> regions_ent;
    uint32_t node_list_checksum;
    struct tagBlock<nodes> nodes_ent;
    struct tagBlock<Bone_Settings> Bone_Settings_ent;
    struct tagBlock<marker_groups> marker_groups_ent;
    struct tagBlock<materials> materials_ent;
    ...
    struct tagBlock<node_map_mapping> node_map_mapping_ent;
    struct tagBlock<runtime_node_orientations> runtime_node_orientations_ent;
    struct tagBlock<bone_groups> bone_groups_ent;
    struct tagBlock<cloth_meshes> cloth_meshes_ent;
    struct tagBlock<cloth_datas> cloth_datas_ent;
    struct tagReference parent_model;
    struct tagBlock<MaterialPipelineStateInfos> MaterialPipelineStateInfos_ent;
    uint32_t generated_pad21f3;
    uint64_t m_instanceGroupPipelineStateCache;
};


#ifdef MODE_STRUCTURE_IMPL
// Tag Structure (used by the loader)

uint8_t mode_structure[] {0x38,0x7,0x38,0x6,0x34,0x34,0x34,0x34,0x3B,0x3B,0x2,0xE,0x3D,0xC,0xA,0x34,0x34,0x34,0x6,0x37,0x6,0x37,0x40,0x2,0x40,0x2,0x5,0x3D,0x2,0x3B,0x3B,0x6,0x40,0x2,0x2E,0x2E,0x2E,0xE,0x17,0x1A,0x19,0x19,0x19,0x17,0x14,0x14,0x37,0xA,0xA,0x3C,0x34,0x2E,0x2E,0x14,0x14,0x1C,0x37,0x3B,0x40,0x2E,0x34,0x34,0x14,0x15,0x8,0x3B,0x40,0x2,0x40,0x4,0x34,0x34,0x34,0x3E,0x3D,0xF,0x34,0x17,0x1A,0x14,0x19,0x3B,0x3B,0x40,0x41,0x3B,0x40,0x1,0xA,0x34,0xE,0x3D,0x34,0x34,0x6,0x40,0xA,0xA,0xE,0x42,0x6,0x0,0x6,0x40,0x38,0x17,0x39,0x0004,0x3C,0x39,0x0004,0x14,0x3B,0x20,0x14,0x3B,0x40,0x38,0x17,0x39,0x0004,0x3C,0x39,0x0004,0x14,0x3B,0x20,0x19,0x14,0x3B,0x40,0x39,0x0002,0x38,0x17,0x39,0x0004,0x3C,0x39,0x0004,0x14,0x3B,0x20,0x3B,0x40,0x39,0x0003,0x38,0x17,0x39,0x0004,0x3C,0x39,0x0004,0x14,0x3B,0x20,0x3B,0x40,0x39,0x0004,0x38,0x17,0x39,0x0004,0x3C,0x39,0x0004,0x14,0x3B,0x20,0x3B,0x40,0x42,0x38,0x17,0x39,0x0004,0x3C,0x39,0x0004,0x14,0x3B,0x20,0x3B,0x6,0x6,0x25,0x25,0x25,0x20,0x3B,0x3B,0x14,0x38,0xD,0x40,0x3E,0x17,0x17,0x16,0x16,0x3B,0x40,0x40,0x40,0x40,0x17,0x16,0x17,0x17,0x17,0x16,0x39,0x0008,0x3C,0x39,0x0008,0x14,0x17,0x16,0x14,0x14,0x17,0x16,0x17,0x3B,0x40,0x3D,0x3B,0x40,0x3E,0x3B,0x40,0x40,0x3D,0x3B,0x40,0x16,0x3B,0x3B,0x40,0x19,0x19,0x20,0x3E,0x3B,0x40,0x3E,0x3B,0x40,0x3E,0x3E,0x14,0x3B,0x40,0x3E,0x3B,0x40,0x3E,0x3E